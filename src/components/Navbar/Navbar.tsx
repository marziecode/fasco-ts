function Navbar() {
  return (
    <div className="w-full  h-20  flex items-center justify-center ">
      <div className="flex items-center justify-between md:w-[1024px] ">
        <div className="w-40 h-full flex justify-center items-center ">
          <h2 className=" text-[#484848] font-[volkhov-regular] font-thin text-6xl cursor-pointer">
            Fasco
          </h2>
        </div>
        <div className="w-full h-full  flex justify-end items-center">
          ...
          <div className="w-[144px] h-full  ml-10 flex justify-center items-center">
            <button className="w-full h-12 bg-black rounded-xl text-white cursor-pointer">
              Sign up
            </button>
          </div>
        </div>
